      ...
      <div className="p-5 flex flex-col h-full gap-4">
        ...
        <div className="flex items-center justify-between pt-1 -mx-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-300 hover:bg-purple-500/20 transition-colors text-xs font-semibold"
            title="Open Obsidian Brain Graph"
          >
            <span>🧠</span>
            <span className="hidden sm:inline font-mono text-[11px]">Brain Map</span>
          </button>
